...
#게임 실행 파일
song_files = {
    "곡1": "RTMG_3",        # song_menu_tiems 에 있는 "곡1" 을 "음악"으로 수정 시
...
# design 에서의 함수 호출==========================================================================================
from design_1 import hitbox_line_color, playtime_explain, count_effect_color, health_bar_explain, push_button_xoffset,combo_and_rate, update_outline_color,color_change
